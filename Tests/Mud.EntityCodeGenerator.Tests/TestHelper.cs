...
/// <summary>
/// 测试辅助工具类，用于获取 Mud.EntityCodeGenerator 程序集中的内部类型
/// </summary>
public static class TestHelper
{
    ...
    static TestHelper()
    {
        var assemblyName = "Mud.EntityCodeGenerator";
    ...
    public static Type GetType(string typeName)
    {
        return GeneratorAssembly.GetType(typeName)
            ?? throw new InvalidOperationException($"无法在 Mud.EntityCodeGenerator 程序集中找到类型: {typeName}");
    }
